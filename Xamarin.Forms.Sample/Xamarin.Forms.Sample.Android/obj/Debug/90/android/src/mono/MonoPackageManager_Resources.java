...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Xamarin.Forms.Sample.Android.dll" comes first in this list. */
		"Xamarin.Forms.Sample.Android.dll",
		"PropertiesValidation.dll",
		"FormsViewGroup.dll",
